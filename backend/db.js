...
/**
 * @param {number} hoursWorked - Clock hours (e.g. 12)
 * @param {number} cycleTimeSec - Cycle time in seconds
 * @param {number|null} pdnReq - PDN required (target)
 * @param {number|null} productedQty - Produced quantity
 * @param {number|null} [actualHoursFromExcel] - If provided (e.g. from Excel "Actual PDN" = hours actually worked), use this instead of hoursWorked×11/12
 */
